  ...
  return (
    <form action={formAction} className="flex flex-col gap-3 rounded border p-4">
      ...
      <label className="flex flex-col gap-1 text-sm">
        Name
        <input name="name" type="text" required className="rounded border px-3 py-2" placeholder="123 Main St" />
      </label>
      <div className="flex gap-3">
        <label className="flex flex-1 flex-col gap-1 text-sm">
          Home type
          <input name="homeType" type="text" className="rounded border px-3 py-2" placeholder="Single-family" />
        </label>
